...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <dubbo:annotation package="com.jin.service.impl"/>
</beans>
~~~
...
<beans xmlns="http://www.springframework.org/schema/beans"
    ...
    <dubbo:registry address="zookeeper://192.168.134.129:2181"/>
    <!-- 扫描的方式暴露接口  -->
    <dubbo:annotation package="com.jin.controller"/>
</beans>
~~~
...
<dubbo:annotation package="com.jin.service"/>
```
...
<bean id="helloService" class="com.jin.service.impl.HelloServiceImpl"/>
<dubbo:service interface="com.jin.api.HelloService" ref="helloService"/>
```
...
<dubbo:reference id="helloService" interface="com.jin.api.HelloService"/>
```
...
<dubbo:protocol name="rmi" port="1099"/>
        <!-- 使用dubbo协议暴露服务 -->
<dubbo:service interface="com.jin.api.HelloService" ref="helloService" protocol="dubbo"/>
        <!-- 使用rmi协议暴露服务 -->
<dubbo:service interface="com.jin.api.DemoService" ref="demoService" protocol="rmi"/> 
```
